    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card ">
              ...
              @endif
              <form class="" action="{{route('karyawan.update', $karyawan->id )}}" method="post" enctype="multipart/form-data">
                @csrf
                  @method('PUT')
                <div class="card-body">
                    <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center">
                      <div class="col-sm-5">
                        ...
                        <input type="text" name="status_karyawan" class="form-control" value="{{ $karyawan->status_karyawan }}">
                      ...
                      <div class="col-sm-5">
                        ...
                        <input type="file" name="foto_karyawan" class="form-control" value="{{ $karyawan->foto_karyawan }}">
                    ...
                    <div class="row justify-content-center">
                      <div class="col-sm-5">
                        ...
                        <input type="text" name="alamat_karyawan" class="form-control" value="{{ $karyawan->alamat_karyawan }}">
                      ...
                      <div class="col-sm-5">
                        ...
                        <input type="email" name="email_karyawan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $karyawan->email_karyawan }}">
